...
#./bin/reframe -C $reframe_configdir/config.py -c $reframe_testdir/fasteddy/fasteddy_tests.py -n FastEddyFullTest --system casper:gpu-mpi -r --purge-env | tee $reframe_logdir/reframe.log
...
./bin/reframe -C $reframe_configdir/config.py -c $reframe_testdir/fasteddy/fasteddy_tests.py -n FastEddyLongMultiGPUTest --system casper:gpu-mpi -r --purge-env | tee $reframe_logdir/reframe.log
